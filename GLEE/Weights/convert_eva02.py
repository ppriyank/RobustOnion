...
model_to_convert = torch.load('Weights/eva02_L_pt_m38m_p14to16.pt', map_location="cpu")
...
torch.save(model_to_save, 'Weights/converted_EVA02_m38m_psz14to16.pth')


# python Weights/convert_eva02.py