...
class GLEE(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        bddk_class = ['person', 'car',  "rider", 'bus', 'truck', "bike", 'motor', 'traffic light',  "traffic sign"]
        dawn_class = ['person',  "bicycle", 'car',  "motorcycle",  'bus', 'truck']
        wedge_class = ['person',  "bicycle", 'car', "motorcycle", "van", 'bus', 'truck']
        city_class=  ['car',  "bicycle", 'bus', 'motorcycle',  'truck']
        ...
        self.category_set = {
            ...
            'bddk': set(list(range(len(bddk_class)))),
            'dawn': set(list(range(len(dawn_class)))),
            'wedge': set(list(range(len(wedge_class)))),
            'city': set(list(range(len(city_class)))),
        }
