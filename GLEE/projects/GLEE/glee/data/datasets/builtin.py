...
_PREDEFINED_SPLITS_ODinW13_image = {
    "odinw13_AerialDrone": ("odinw/AerialMaritimeDrone/large/valid/", "odinw/AerialMaritimeDrone/large/valid/annotations_without_background.json"),
    "odinw13_Aquarium":  ("odinw/Aquarium/Aquarium Combined.v2-raw-1024.coco/valid" , "odinw/Aquarium/Aquarium Combined.v2-raw-1024.coco/valid/annotations_without_background.json"),
    "odinw13_Rabbits":   ("odinw/CottontailRabbits/valid" , "odinw/CottontailRabbits/valid/annotations_without_background.json"),
    "odinw13_EgoHands":  ("odinw/EgoHands/generic/mini_val" , "odinw/EgoHands/generic/mini_val/annotations_without_background.json"),
    "odinw13_Mushrooms":  ("odinw/NorthAmericaMushrooms/North American Mushrooms.v1-416x416.coco/valid" , "odinw/NorthAmericaMushrooms/North American Mushrooms.v1-416x416.coco/valid/annotations_without_background.json"),
    "odinw13_Packages":  ("odinw/Packages/Raw/valid" , "odinw/Packages/Raw/valid/annotations_without_background.json"),
    "odinw13_PascalVOC":  ("odinw/PascalVOC/valid" , "odinw/PascalVOC/valid/annotations_without_background.json"),
    "odinw13_Pistols":  ("odinw/pistols/export" , "odinw/pistols/export/val_annotations_without_background.json"),
    "odinw13_Pothole":  ("odinw/pothole/valid" , "odinw/pothole/valid/annotations_without_background.json"),
    "odinw13_Raccoon":  ("odinw/Raccoon/Raccoon.v2-raw.coco/valid" , "odinw/Raccoon/Raccoon.v2-raw.coco/valid/annotations_without_background.json"),
    "odinw13_Shellfish":  ("odinw/ShellfishOpenImages/raw/valid" , "odinw/ShellfishOpenImages/raw/valid/annotations_without_background.json"),
    "odinw13_Thermal":  ("odinw/thermalDogsAndPeople/valid" , "odinw/thermalDogsAndPeople/valid/annotations_without_background.json"),
    "odinw13_Vehicles":  ("odinw/VehiclesOpenImages/416x416/mini_val" , "odinw/VehiclesOpenImages/416x416/mini_val/annotations_without_background.json"),
}
...
_PREDEFINED_SPLITS_FLICKER = {
    "flicker-train": ("flickr_dataset_30k/flickr30k/flickr30k-images/", "flickr_dataset_30k/mdetr_annotations/final_flickr_separateGT_train.json"),
    "flicker-val": ("flickr_dataset_30k/flickr30k/flickr30k-images/", "flickr_dataset_30k/mdetr_annotations/final_flickr_separateGT_val.json"),
    "flicker-test": ("flickr_dataset_30k/flickr30k/flickr30k-images/", "flickr_dataset_30k/mdetr_annotations/final_flickr_separateGT_test.json"),
    "flicker-subset": ("flickr_dataset_30k/flickr30k/flickr30k-images/", "../DATASET/final_flickr_separateGT_train_subset3.json"),
    "flicker-subset2": ("flickr_dataset_30k/flickr30k/flickr30k-images/", "../DATASET/final_flickr_separateGT_train_subset4.json"),
}
