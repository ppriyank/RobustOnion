...
flickr30k_dataset = dict(
    type='ODVGDataset_Peturb',
    data_root='data/flickr30k_entities/',
    ann_file='../DATASET/final_flickr_separateGT_train_subset3_vg.json',
    label_map_file=None,
...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=13000, max_keep_ckpts=30, save_best='auto', rule='greater'))
