...
dataset_CottontailRabbits = dict(
    ...
    metainfo=metainfo,
    data_root=_data_root,
    ann_file='Odinw35_new_annotations/CottontailRabbits-new_annotations_without_background.json',
    data_prefix=dict(img='valid/'),
    pipeline=_base_.test_pipeline,
    test_mode=True,
    return_classes=True)
...
dataset_NorthAmericaMushrooms = dict(
    ...
    metainfo=metainfo,
    data_root=_data_root,
    ann_file='Odinw35_new_annotations/NorthAmericaMushrooms-new_annotations_without_background.json',
    data_prefix=dict(img='valid/'),
    pipeline=_base_.test_pipeline,
    test_mode=True,
    return_classes=True)
