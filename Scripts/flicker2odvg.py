# https://github.com/open-mmlab/mmdetection/blob/main/tools/dataset_converters/goldg2odvg.py
import argparse
...
# cd ~/robustness_object_detection/Scripts/
# python flicker2odvg.py ../DATASET/final_flickr_separateGT_train_subset3.json
# python flicker2odvg.py ../DATASET/final_flickr_separateGT_train_subset4.json
