...
def try_to_find(file, return_dir=False, search_path=['./DATASET', './OUTPUT', './data', './MODEL']):
    ...
    if 'ADD_DATASET' in os.environ:
        DATASET_PATH.append(os.environ['ADD_DATASET'])
...
class DatasetCatalog(object):
    DATASETS = {
        ...
        # flickr30k
        "flickr30k_train": {
            "img_folder": "flickr30k/flickr30k-images/",
        ...
        "flickr30k_train_subset3": {
            "img_folder": "flickr30k/flickr30k-images",
            "ann_file": "../DATASET/final_flickr_separateGT_train_subset3.json",
            "is_train": True
        },
        "flickr30k_train_debug": {
            "img_folder": "flickr30k/flickr30k-images",
            "ann_file": "../DATASET/final_flickr_separateGT_train_debug.json",
            "is_train": True
        },
        ...
        "bdd100k_train": {
            ...
            'ann_file': "BDDK_train-1.json"
        },
        ##### 1000 train points 
        "bdd100k_train2": {
            'img_dir': "bdd100k/images/100k/train", 
            'ann_file': "BDDK_train-2.json"
        },
        ##### 100 train points 
        "bdd100k_train-grounding": {
            'img_dir': "bdd100k/images/100k/train", 
            'ann_file': "BDDK_train-1.json"
        },
        ##### Entire Training Set
        "bdd100k_all_train-grounding": {
            'img_dir': "bdd100k/images/100k/train", 
            'ann_file': "bdd100k/labels_coco/bdd100k_labels_images_train_coco.json"
        },
        ...
        "bdd100k_debug": {
            'img_dir': "bdd100k/images/100k/train", 
            'ann_file': "bdd100k_debug-2.json"
        },
        
        "bdd100k_val": {
            'img_dir': "bdd100k/images/100k/val", 
            'ann_file': "bdd100k/labels_coco/bdd100k_labels_images_val_coco.json"
        },
        "bdd100k_det_train": {
            'img_dir': "bdd100k/images/100k/train", 
            'ann_file': "bdd100k/labels_coco/bdd100k_labels_images_train_coco.json"
        ...
        "bdd100k_val2": {
            'img_dir': "bdd100k/images/100k/val", 
            'ann_file': "BDDK_CATEGORY_test-1.json",
        },
        

        "dawn_debug": {
            'img_dir': "DAWN2/",
            'ann_file': "DAWN2/labels_coco/DAWN_debug.json"
        },
        "dawn_train": {
            'img_dir': "DAWN2/",
            'ann_file': "DAWN_train.json"
        },
        "dawn_test": {
            'img_dir': "DAWN2/",
            'ann_file': "DAWN2/labels_coco/DAWN_test.json"
        },
        "dawn_category_train": {
            'img_dir': "DAWN2/",
            'ann_file': "DAWN_CATEGORY_train.json"
        },
        
        "wedge_debug": {
            'img_dir': "WEDGE/",
            'ann_file': "WEDGE/labels_coco/WEDGE_debug.json"
        },
        "wedge_debug-grounding": {
            'img_dir': "WEDGE/",
            'ann_file': "WEDGE/labels_coco/WEDGE_debug.json"
        },
        "wedge_train": {
            'img_dir': "WEDGE/",
            'ann_file': "WEDGE/labels_coco/WEDGE_train.json"
        },
        "wedge_train-grounding": {
            'img_dir': "WEDGE/",
            'ann_file': "WEDGE/labels_coco/WEDGE_train.json"
        },
        "wedge_test": {
            'img_dir': "WEDGE/",
            'ann_file': "WEDGE/labels_coco/WEDGE_test.json"
        },

        "FoggyCityscape_amodal_train": {
            'img_dir': "leftImg8bit_foggyDBF/train/",
            'ann_file': "Foggy_train-amodal-1.json"
        },

        "FoggyCityscape_modal_train": {
            'img_dir': "leftImg8bit_foggyDBF/train/",
            'ann_file': "Foggy_train-modal-1.json"
        },

        "FoggyCityscape_amodal_val": {
            'img_dir': "leftImg8bit_foggyDBF/val/",
            'ann_file': "leftImg8bit_foggyDBF/labels_coco/Cityscape_labels_val_amodal.json"
        },

        "FoggyCityscape_modal_val": {
            'img_dir': "leftImg8bit_foggyDBF/val/",
            'ann_file': "leftImg8bit_foggyDBF/labels_coco/Cityscape_labels_val_modal.json"
        },

        "kitti_test": {
            'img_dir': "VirtualKitti/",
            'ann_file': "VirtualKitti/labels_coco/kitti_labels_images_val_coco.json"
        },
        "kitti_debug": {
            'img_dir': "VirtualKitti/",
            'ann_file': "kitti_debug.json"
        },
        "kitti_debug2": {
            'img_dir': "VirtualKitti/",
            'ann_file': "kitti_debug-2.json"
        },
        "kitti_val": {
            'img_dir': "VirtualKitti/",
            'ann_file': "kitti_val-1.json"
        },
        "kitti_train-grounding": {
            'img_dir': "VirtualKitti/",
            'ann_file': "VirtualKitti/labels_coco/kitti_labels_images_train_coco.json"
        },
        "kitti_train-grounding-debug": {
            'img_dir': "VirtualKitti/",
            'ann_file': "kitti_debug-2.json"
        },
        "kitti_Grounding_Pairs-grounding": {
            'img_dir': "VirtualKitti/",
            'ann_file': "VirtualKitti/labels_coco/kitti_labels_images_train_coco.json"
        },
        ...
        "wider_face-val": {
            'img_dir': "WIDER_FACE/",
            'ann_file': "WIDER_FACE/labels_coco/wider_face_labels_images_val_coco.json"
        },
        "wider_face-debug": {
            'img_dir': "WIDER_FACE/",
            'ann_file': "WIDER_FACE_debug.json"
        },

        
        "vis_dron2019-test": {
            'img_dir': "VisDrone2019-DET-val/images/",
            'ann_file': "VisDrone2019-DET-val/labels_coco/visiondrone_val_label.json"
        },
        "vis_dron2019-test-easy": {
            'img_dir': "VisDrone2019-DET-val/images/",
            'ann_file': "VisDrone2019-DET-val/labels_coco/visiondrone_val_label-easy.json"
        },
        "vis_dron2019-val": {
            'img_dir': "VisDrone2019-DET-val/images/",
            'ann_file': "VIS_DRONE2019_debug.json"
        },
        


        "UAVDT-debug": {
            'img_dir': "UAVDT/images/UAV-benchmark-M/",
            'ann_file': "UAVDT_debug.json"
        },
        "UAVDT-grounding": {
            'img_dir': "UAVDT/images/UAV-benchmark-M/",
            'ann_file': "UAVDT/labels_coco/UAVDT_train_label.json"
        },
        "UAVDT-grounding2": {
            'img_dir': "UAVDT/images/UAV-benchmark-M/",
            'ann_file': "UAVDT/labels_coco/UAVDT_train_label-2.json"
        },
    ...
    def get(name):
        ...
        if name.endswith('_bg'):
            ...
            if "voc" in name and 'split' in attrs:
            ...
            elif "bdd" in name or "dawn" in name or "wedge" in name \
                or 'FoggyCityscape' in name or 'kitti' in name or 'wider_face' in name \
                or 'vis_dron2019-val' in name or 'UAVDT' in name:
                ann_dir = try_to_find(attrs["ann_file"], return_dir=True)
                img_dir = try_to_find(attrs["img_dir"], return_dir=True)
                args = dict(
                ...
                if "dawn" in name:
                    return dict( factory="DAWN", args=args,)
                elif "FoggyCityscape" in name:
                    return dict( factory="FoggyCityscape", args=args,)
                elif "wedge" in name:
                    if "grounding" in name:
                        args['img_folder'] = args['root']
                        del args['root']
                        return dict( factory="WEDGE_Grounding", args=args,)
                    else:
                        return dict( factory="WEDGE", args=args,)
                elif "kitti" in name:
                    if "grounding" in name:
                        args['img_folder'] = args['root']
                        del args['root']
                        if "Pairs" in name:
                            return dict( factory="VirtualKitti_Grounding_Pairs", args=args,)
                        else:
                            return dict( factory="VirtualKitti_Grounding", args=args,)
                    else:
                        return dict( factory="VirtualKitti", args=args,)
                elif "bdd100k" in name:
                    if "grounding" in name:
                        args['img_folder'] = args['root']
                        del args['root']
                        return dict( factory="BDD100K_Grounding", args=args,)
                    else:
                        return dict( factory="BDD100K", args=args,)
                elif "wider_face" in name:
                    return dict( factory="WIDER_FACE", args=args,)
                elif "vis_dron2019-val" in name:
                    return dict( factory="VIS_DRONE2019", args=args,)
                elif 'UAVDT' in name:
                    if "grounding" in name:
                        args['img_folder'] = args['root']
                        del args['root']
                        return dict( factory="UAVDT_Grounding", args=args,)
                    else:
                        return dict( factory="UAVDT", args=args,)
