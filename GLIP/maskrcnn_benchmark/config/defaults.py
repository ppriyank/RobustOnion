...
_C.DATASETS.DATALOADER = None
_C.DATASETS.DATALOADER_MODE = None
_C.DATASETS.TEST_NOISE = None

_C.DATASETS.TRAIN_DATALOADER = None
_C.DATASETS.TEST_DATALOADER = None

_C.MODEL.NO_NORM = None 
_C.MODEL.BACKBONE_TYPE = None 
_C.MODEL.E2E = False 
_C.MODEL.BACKBONE_E2E = False 
_C.MODEL.E2E_MODE = ''

_C.MODEL.RPN.EXPLICIT_FREEZE = False 
_C.DATASETS.N_LR = 2 ## type of noises 
_C.DATASETS.N_BR = 2 ## no of instances of noises 
_C.DATASETS.ONE_NOISE = False 


_C.MODEL.RPN.NO_FUSE = None  
_C.TEST.PREDICT = 'True'
_C.TEST.DUMP_INDEX = None 

_C.MODEL.BACKBONE.PROMPT_NUM_TOKEN=[]
_C.DATASETS.FOG_LEVEL = None  
_C.DATASETS.REPLICA_END= None
